...
import com.netkiller.search.query.GaeJdoQueryBuilder;
import com.netkiller.search.query.InequalityRestrictionHandler;
import com.netkiller.search.query.QueryBuilder;
import com.netkiller.service.KeyListService;
import com.netkiller.util.AppLogger;
import com.netkiller.util.CacheUtil;
import com.netkiller.util.EntityComparator;
import com.netkiller.util.KeyUtil;
import com.netkiller.util.PerfLogger;
...
public class SearchService {
	...
	private SearchResultVO executeQuery(
			com.netkiller.search.query.Query builtQuery,
	...
	private String getFilterString(
			com.netkiller.search.query.Query query) {
	...
	private class SearchQueryDirector {
		...
		public com.netkiller.search.query.Query buildQuery(
	...
	private SearchResultVO fetchSearchResults(SearchRequest srchRequest)
			throws AppException {
		com.netkiller.search.query.Query builtQuery = null;
