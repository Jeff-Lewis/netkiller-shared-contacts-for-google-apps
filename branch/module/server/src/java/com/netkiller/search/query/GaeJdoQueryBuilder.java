...
public class GaeJdoQueryBuilder implements QueryBuilder {
	...
	@Override
	public com.netkiller.search.query.Query buildCompleteQuery() throws AppException {
		...
		com.netkiller.search.query.Query query =  new com.netkiller.search.query.Query(rootEntity, filterFragmentString, orderByFragmentString,
